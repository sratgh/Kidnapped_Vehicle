 ...
 *
 * Looked at and got inspired by the following implementations
 * https://github.com/mvirgo/Kidnapped-Vehicle-Project/blob/master/src/particle_filter.cpp
 * https://github.com/sohonisaurabh/CarND-Kidnapped-Vehicle-Project/blob/master/src/particle_filter.cpp
 * https://github.com/jeremy-shannon/CarND-Kidnapped-Vehicle-Project/blob/master/src/particle_filter.cpp
 * https://github.com/anudeepsekhar/CarND-Kidnapped-Vehicle-Project/blob/master/src/particle_filter.cpp
 */
 ...
 void ParticleFilter::resample() {
   ...
   // Pick out of bag of particles with replacement (See lecture)
  	for(unsigned int i = 0; i < particles.size(); ++i) {
        int particle_index = particle_dist(gen);
